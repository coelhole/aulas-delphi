program CadastroUsuarios2;//CadastroUsuario goto version
...
label menu,cadastrarUsuario,pesquisarUsuario,excluirUsuario,listarUsuarios,sair;
...
menu:
  ...
  case opcao[1] of
    'a','A': goto cadastrarUsuario;
    'b','B': goto pesquisarUsuario;
    'c','C': goto excluirUsuario;
    'd','D': goto listarUsuarios;
    'e','E': goto sair;
