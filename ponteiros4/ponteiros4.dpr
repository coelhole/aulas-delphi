...
begin
  ...
  int1:=2030;//pint1 aponta para int1, logo, a partir de agora, pint1^ = pint2^ = int1 = 2030
  writeln('int1:=2030;');
  writeln('int1 = ',int1);
  writeln('Endereco de memoria guardado no ponteiro pint1: ',integer(pint1));
  writeln(format('Endereco de memoria guardado no ponteiro pint1 (em hexadecimal): %p',[pint1]));
  ...
  int2:=22;//pint1 não aponta para int2, bem como pint2 também não (porque fizemos pint2:=pint1), de modo que nada muda: ainda pint1^ = pint2^ = int1 = 2030 
  writeln('int2:=22;');
  writeln('int2 = ',int2);
  writeln('Endereco de memoria guardado no ponteiro pint1: ',integer(pint1));
  writeln(format('Endereco de memoria guardado no ponteiro pint1 (em hexadecimal): %p',[pint1]));
